...
export function InvoicePrintPreview({
  ...
  const [clinicName, setClinicName] = useState("Clinic OS");
          ...
          {loading ? (
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-2xl font-bold">{clinicName}</p>
              ...
              <div className="pt-6 border-t border-gray-100 text-center text-xs text-gray-400 footer">
                ...
                <p className="mt-1">
                  Generated by {clinicName} · {new Date().toLocaleDateString()}
                </p>
              </div>
            </div>
          )}
